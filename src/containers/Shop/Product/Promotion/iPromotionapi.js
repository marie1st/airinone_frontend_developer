...
export const IPromotionApi = () => {
  ...
  async function fetchData() {
    ...
    const response = await fetch("http://localhost:3000/promotional-products-percents")
      .then(response => response.json())
      .then(response => SetItem(response));
    const resp = await fetch("http://localhost:3000/promotional-products-giveaways")
      .then(resp => resp.json())
