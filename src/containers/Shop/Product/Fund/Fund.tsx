...
export const Fund = () => {
  ...
  return (
    <>
      ...
      {/* ModalA here */}
      <Modal modal={modalA}>
        <Modal.Header>+ ค่าแรง</Modal.Header>
        <Modal.Body>
        ...
        <Modal.Footer className="flex">
          ...
          <Spacer flexFill />
          <Button color="grey" onClick={modalA.close}>
            ปิด
          </Button>
          <Spacer />
      ...
      {/* ModalB here */}
      <Modal modal={modalB}>
        <Modal.Header>+ ค่าของ</Modal.Header>
        <Modal.Body>
          <div className={styles.row}>
            <div className={styles.col}>
              <label>ประเภท</label>
        ...
        <Modal.Footer className="flex">
          <Button color="red">ลบทั้งหมด</Button>
          <Spacer flexFill />
          <Button color="grey" onClick={modalB.close}>
            ปิด
          </Button>
          <Spacer />
          <Button color="green">บันทึก</Button>
      ...
      {/* ModalC here */}
      <Modal modal={modalC}>
        <Modal.Header>+ ค่าติดตั้งพรีเมี่ยม</Modal.Header>
        <Modal.Body>
          <div className={styles.row}>
            <div className={styles.col}>
              <label>ประเภท</label>
        ...
        <Modal.Footer className="flex">
          <Button color="red">ลบทั้งหมด</Button>
          <Spacer flexFill />
          <Button color="grey" onClick={modalC.close}>
            ปิด
          </Button>
          <Spacer />
          <Button color="green">บันทึก</Button>
